...
1. Navigate back to the **Fabric Workspace**, click the **+ New item (1)** button and select **Data   pipeline (2)**.
...
8. In the **Connect to data destination** window, click **Browse (1)**, then click **OK (2)**, and select **Next (3)**. This will write the data to the Files section of the lakehouse.
...
10. You can monitor the pipeline execution and activity in the **Output** tab. You can also view detailed data transfer information by selecting the glasses icon next to the pipeline name, which appears when you hover over the name
    ...
    > If the Activity Status shows **Failed**, follow the steps below to delete the **Data Pipeline** and restart the task.

    >**1.** Navigate back to the **Fabric Lakehouse (1)** and verify the presence of your **Data Pipeline (2)**.

    >![add-pipeline-copy-data](../media/10/p10_1.png) 

    >**2.** Click on **Ellipsis icon ( ... ) (1)**, then select **Delete (2)**.

    >![add-pipeline-copy-data](../media/10/p10_2.png) 

    >**3.** Click the **Delete** button to remove the **Data Pipeline**.

    >![add-pipeline-copy-data](../media/10/p10_3.png) 

    >**4.** Wait for **5 minutes**, then repeat **Step 1**. Upon repeating, the **Activity Status** should indicate **Succeeded**.


11. Now, navigate back to **Fabric workspace** and select **wwilakehouse** to launch **Lakehouse explorer**.

    ![add-pipeline-copy-data](../media/09/22a_new.png)

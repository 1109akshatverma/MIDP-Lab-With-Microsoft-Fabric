...
8. Click **Next**. In **Review + Save** tab the copy summary should be set as **Binary to Binary**. Click **Save + Run**. You can schedule pipelines to refresh data periodically. In this tutorial, we only run the pipeline once. The data copy process takes approximately 10-15 minutes to complete.

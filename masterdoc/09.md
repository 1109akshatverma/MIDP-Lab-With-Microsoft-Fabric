...
1. To ensure that the tables in the semantic model are always in sync, switch to the **SQL analytics endpoint**, Click on **...** to get setting options. 
...
1. Enter a name for your report **(1)** and click on **Save (2)**.

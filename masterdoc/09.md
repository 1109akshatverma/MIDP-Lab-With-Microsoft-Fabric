...
1. In the pop-up window, provide the name as **Dataflow 1 (1)** and select **Create (2)** to proceed.
...
11. Now, in the **Query** editor, click on **Add data destination (2)**, and select **Lakehouse (3)**.

    ![set-data-lakehouse-dest](../media/09/Query.png)
